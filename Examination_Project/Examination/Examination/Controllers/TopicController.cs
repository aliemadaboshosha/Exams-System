...
namespace Examination.Controllers
{
    public class TopicController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id, int? courseId)
        {
            ...
            var topic = await _topicRepo.GetById(id.Value, courseId.Value);
            if (topic == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Update(int? id, int? courseId)
        {
            if (id == null)
            {
                return BadRequest();
        ...
        public async Task<ActionResult?> Delete(int? id, int? courseId)
        {
            if (id == null)
            {
                return BadRequest();
            ...
            _topicRepo.Delete(id.Value, courseId.Value);
            return RedirectToAction("Index");
        }
    }
}
